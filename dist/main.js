...
var TimeseriesPlot = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(TimeseriesPlot, [{
    ...
    value: function getCIs(data) {
      ...
      var ci = Object.keys(data[0]).map(function (key) {
        return _this2.parseCI(key);
      });
      var ci = ci.filter(function (x) {
        return x !== undefined;
      });
      return ci;
    }
    ...
    value: function parseCI(key) {
      ...
      if (key.includes('lower_')) {
        ...
        return {
          value: value,
          lower_name: 'lower_' + value,
          upper_name: 'upper_' + value
        };
      } else {
        return undefined;
      }
  ...
  src_createClass(App, [{
    ...
    value: function render() {
      if (this.props.widget == 'summaryWidget') {
        return /*#__PURE__*/src_React.createElement("div", null, /*#__PURE__*/src_React.createElement(SummaryWidget, {
          x: this.props.x
        }));
      } else {
